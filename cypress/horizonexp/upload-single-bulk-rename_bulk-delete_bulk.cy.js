describe("Content Upload & Publishing", () => {
  ...
  it("uploads single file, publishes it, then performs bulk upload with CSV and bulk publish, then verifies in Library", () => {
    ...
    // --- NEW: Verify in Library ---
    cy.log("🔍 Verifying published single video in Library");
    navigateToLibrary();
    verifyVideoDetails(
      "Test Upload Video",
      "This is a test caption generated by automation."
    );
    ...
    verifyVideoDetails(null, null); // Just verify we can open and close details
